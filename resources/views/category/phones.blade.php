...
<div class="page-header text-center" style="background-image: url('{{ asset('images/page-header-bg.jpg') }}')">
    <div class="container">
        <h1 class="page-title">Smart Phones<span>Shop</span></h1>
    </div><!-- End .container -->
</div><!-- End .page-header -->
                            ...
                            <div class="col-6 col-md-4 col-lg-4">
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="{{ route('products.show', $phone->id) }}">
                                    ...
                                    <div class="product-body">
                                        <div class="product-cat">
                                            <a href="#">{{ $phone->category->name }}</a>
                                        </div>
                                        <h3 class="product-title"><a href="{{ route('products.show', $phone->id) }}">{{ $phone->name }}</a></h3>

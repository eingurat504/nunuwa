...
<div class="page-header text-center" style="background-image: url('{{ asset('images/page-header-bg.jpg') }}')">
    <div class="container">
        <h1 class="page-title">Healthy and Beauty<span>Shop</span></h1>
    </div>
</div>
                            ...
                            <div class="col-6 col-md-4 col-lg-4">
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="{{ route('products.show', $beauty->id) }}">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            ...
                                            <input type="hidden" name="name" value="{{ $beauty->name }}">
                                            <input type="hidden" name="price" value="{{ $beauty->price }}">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="{{ route('products.show', $beauty->id) }}">{{ $beauty->name }}</a></h3>
                                        <div class="product-price">${{ $beauty->price }}</div>

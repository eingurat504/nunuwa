...
<div class="page-header text-center" style="background-image: url('{{ asset('images/page-header-bg.jpg') }}')">
    <div class="container">
        <h1 class="page-title">TVs and Audios<span>Shop</span></h1>
    </div>
</div>
                            ...
                            <div class="col-6 col-md-4 col-lg-4">
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="{{ route('products.show', $audio) }}">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            ...
                                            <input type="hidden" name="name" value="{{ $audio->name }}">
                                            <input type="hidden" name="price" value="{{ $audio->price }}">

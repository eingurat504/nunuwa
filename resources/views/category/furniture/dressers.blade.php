                            ...
                            <div class="col-6 col-md-4 col-lg-4">
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        <a href="{{ route('products.show', $dresser->id) }}">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="id" value="{{ $dresser->id }}">
                                            <input type="hidden" name="name" value="{{ $dresser->name }}">
                                            <input type="hidden" name="price" value="{{ $dresser->price }}">
                                    ...
                                    <div class="product-body">
                                        <div class="product-cat">
                                            <a href="#">{{ $dresser->category->name }}</a>
                                        </div>
                                        <h3 class="product-title"><a href="#">{{ $dresser->name }}</a></h3>
                                        <div class="product-price">${{ $dresser->price }}</div>

                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="id" value="{{ $coffee_table->id }}">
                                            <input type="hidden" name="name" value="{{ $coffee_table->name }}">
                                            <input type="hidden" name="price" value="{{ $coffee_table->price }}">

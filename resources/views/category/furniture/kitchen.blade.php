                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <form action="{{ route('cart.store') }}" method="POST">
                                            {{ csrf_field() }}
                                            <input type="hidden" name="id" value="{{ $kitchen_cabinet->id }}">
                                            <input type="hidden" name="name" value="{{ $kitchen_cabinet->name }}">
                                            <input type="hidden" name="price" value="{{ $kitchen_cabinet->price }}">

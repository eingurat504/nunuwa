...
<div class="page-header text-center" style="background-image: url('{{ asset('images/page-header-bg.jpg') }]')">
    <div class="container">
        <h1 class="page-title">Jewlery and Watches<span>Shop</span></h1>
    </div><!-- End .container -->
</div><!-- End .page-header -->
                                ...
                                <div class="product product-7 text-center">
                                    ...
                                    <div class="product-body">
                                        <div class="product-cat">
                                            <a href="#">{{ $jewlery->category->name }}</a>
                                        </div>
                                        <h3 class="product-title"><a href="#">{{ $jewlery->name }}</a></h3>
                                        <div class="product-price">${{ $jewlery->price }}</div>

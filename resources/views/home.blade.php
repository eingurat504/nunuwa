                    ...
                    <div class="row">
                        <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                            ...
                            <a href="index.html" class="logo">
                                <img src="{{ asset('images/demos/demo-14/logo.png') }}" alt="Molla Logo" width="105" height="25">
                            </a>
                    ...
                    <div class="col-xl-9 col-xxl-10">
                                    ...
                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{ asset('images/demos/demo-14/products/product-1.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-sale">Sale</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('images/demos/demo-14/products/product-2.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('images/demos/demo-14/products/product-3.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('images/demos/demo-14/products/product-4.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{ asset('images/demos/demo-14/products/product-5.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-top">Top</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('images/demos/demo-14/products/product-6.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    @foreach($furnitures as $furniture) 
                                            <div class="product text-center">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h3 class="product-title"><a href="product.html">{{ $furniture->name }}</a></h3>
                                                    <div class="product-price">
                                    ...
                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        @foreach($clothings as $clothing) 
                                            <div class="product text-center">
                                                ...
                                                <div class="product-body">
                                                    <div class="product-cat">
                                                        <a href="#">{{ $clothing->category->name }}</a>
                                                    </div>
                                                    <h3 class="product-title"><a href="product.html">{{ $clothing-> name }}</a></h3>
                                                    <div class="product-price">
                                ...
                                <div class="tab-pane p-0 fade" id="trending-acc-tab" role="tabpanel" aria-labelledby="trending-acc-link">
                                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <a href="product.html">
                                                    <img src="{{ asset('images/demos/demo-14/products/product-4.jpg')
                            ...
                            <div class="col-xl-3 col-xxl-4">
                                <div class="cat-banner row no-gutters">
                                    ...
                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                        <div class="banner banner-overlay">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo-14/banners/banner-5.jpg') }}" alt="Banner img desc">
                                            </a>
                            ...
                            <div class="col-xl-9 col-xxl-8">
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-7.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            ...
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-8.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            ...
                                            <span class="product-label label-sale">Sale</span>
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-9.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                            ...
                            <div class="col-xl-3 col-xxl-4">
                                <div class="cat-banner row no-gutters">
                                    ...
                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                        <div class="banner banner-overlay">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo-14/banners/banner-6.jpg') }}" alt="Banner img desc">
                                            </a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('images/demos/demo-14/banners/banner-7.jpg') }}" alt="Banner img desc">
                                    </a>
                            ...
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('images/demos/demo-14/banners/banner-8.jpg') }}" alt="Banner img desc">
                                    </a>
                            ...
                            <div class="col-xl-3 col-xxl-4">
                                <div class="cat-banner row no-gutters">
                                    ...
                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                        <div class="banner banner-overlay">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo-14/banners/banner-9.jpg') }}" alt="Banner img desc">
                                            </a>
                            ...
                            <div class="col-xl-9 col-xxl-8">
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-14.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">New</span>
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-15.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-17.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                            ...
                            <div class="col-xl-3 col-xxl-4">
                                <div class="cat-banner row no-gutters">
                                    ...
                                    <div class="col-sm-6 col-xl-12 col-xxl-6">
                                        <div class="banner banner-overlay">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo-14/banners/banner-10.jpg') }}" alt="Banner img desc">
                                            </a>
                            ...
                            <div class="col-xl-9 col-xxl-8">
                                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-19.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-20.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">New</span>
                                            <a href="product.html">
                                                <img src="{{ asset('images/demos/demo-14/products/product-21.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xl-12">
                                    <div class="widget widget-banner">
                                        <div class="banner banner-overlay">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo-14/banners/banner-11.jpg') }}" alt="Banner img desc">
                                            </a>
                                    ...
                                    <div class="widget widget-products">
                                        ...
                                        <div class="products">
                                            <div class="product product-sm">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('images/demos/demo-14/products/small/product-1.jpg') }}" alt="Product image" class="product-image">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('images/demos/demo-14/products/small/product-2.jpg') }}" alt="Product image" class="product-image">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('images/demos/demo-14/products/small/product-3.jpg') }}" alt="Product image" class="product-image">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('images/demos/demo-14/products/small/product-4.jpg') }}" alt="Product image" class="product-image">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="product product-sm">
                                                <figure class="product-media">
                                                    <a href="product.html">
                                                        <img src="{{ asset('images/demos/demo-14/products/small/product-5.jpg') }}" alt="Product image" class="product-image">
                                                    </a>
                                                </figure>
                                            ...
                                            <div class="col-sm-6 col-xl-12">
                                                <div class="product text-center">
                                                    <figure class="product-media">
                                                        ...
                                                        <a href="product.html">
                                                            <img src="{{ asset('images/demos/demo-14/products/deals/product-1.jpg') }}" alt="Product image" class="product-image">
                                                        </a>
                                            ...
                                            <div class="col-sm-6 col-xl-12">
                                                <div class="product text-center">
                                                    <figure class="product-media">
                                                        <span class="product-label label-sale">Deal of the week</span>
                                                        <a href="product.html">
                                                            <img src="{{ asset('images/demos/demo-14/products/deals/product-2.jpg') }}" alt="Product image" class="product-image">
                                                        </a>
                                ...
                                <div class="col-sm-6 col-xl-12">
                                    <div class="widget widget-banner">
                                        <div class="banner banner-overlay">
                                            <a href="#">
                                                <img src="{{ asset('images/demos/demo-14/banners/banner-12.jpg') }}" alt="Banner img desc">
                                            </a>
                                        ...
                                        <div class="owl-carousel owl-simple" data-toggle="owl" 
                                            ...
                                            <article class="entry">
                                                <figure class="entry-media">
                                                    <a href="single.html">
                                                        <img src="{{ asset('images/demos/demo-14/blog/post-1.jpg') }}" alt="image desc">
                                                    </a>
                                            ...
                                            <article class="entry">
                                                <figure class="entry-media">
                                                    <a href="single.html">
                                                        <img src="{{ asset('images/demos/demo-14/blog/post-2.jpg') }}" alt="image desc">
                                                    </a>
                                                </figure><!-- End .entry-media -->
                                            ...
                                            <article class="entry">
                                                <figure class="entry-media">
                                                    <a href="single.html">
                                                        <img src="{{ asset('images/demos/demo-14/blog/post-3.jpg') }}" alt="image desc">
                                                    </a>
                                                </figure><!-- End .entry-media -->
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="{{ asset('images/popup/newsletter/logo.png') }}" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{{ asset('images/popup/newsletter/img-1.jpg') }}" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
